...
public class QComment extends EntityPathBase<Comment> {
    ...
    private static final long serialVersionUID = -1082221286L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QComment comment = new QComment("comment");

    public final DateTimePath<java.time.LocalDateTime> commentDateTime = createDateTime("commentDateTime", java.time.LocalDateTime.class);
